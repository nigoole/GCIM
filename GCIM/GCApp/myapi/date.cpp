...
quint16 Date::getSpringFestivalDate(int year)
{
    ...
    myDebug(springFestivalMonth << springFestivalDay);
...
QString Date::getBeforDays(int nInterval)
{
    ...
    QString fileName = "";
    fileName.append(QString("%1").arg(QDate::currentDate().toString("yyyyMMdd")));
    fileName.append(QString("%1").arg(h, 2, 10, QChar('0')));
    fileName.append(QString("%1").arg(m, 2, 10, QChar('0')));
#endif
    return fileName;
}
